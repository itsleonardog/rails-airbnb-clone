...
class AccommodationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create accommodation" do
    assert_difference("Accommodation.count") do
      post accommodations_url, params: { accommodation: { address: @accommodation.address, name: @accommodation.name, rating: @accommodation.rating } }
    end
  ...
  test "should update accommodation" do
    patch accommodation_url(@accommodation), params: { accommodation: { address: @accommodation.address, name: @accommodation.name, rating: @accommodation.rating } }
